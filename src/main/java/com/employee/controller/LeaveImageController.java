...
//	@PostMapping()
//	public ResponseEntity<?> uploadImageToFIleSystem(@RequestBody LeaveImage leaveImage, @RequestParam("image")MultipartFile file) throws IOException {
//		String uploadImage = this.leaveImageService.uploadImageToFileSystem(leaveImage, file);
//		
...
//	}
	...
	//	public LeaveImage uploadLeaveImage(@RequestParam ("image") MultipartFile file) throws IOException
//	{
//	 
//		return this.leaveImageService.uploadImageToFileSystem(file);
//		
//	}
